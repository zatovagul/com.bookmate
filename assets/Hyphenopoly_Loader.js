...
(function H9YL() {
    ...
    /**
     * window.fetch doesn't support file scheme. So we are using XHR here.
    ...
    function featureTestWasm() {
        ...
        function runWasmTest() {
             ...
             *     var module = new WebAssembly.Module(Uint8Array.from(
    ...
    (function featureTestCSSHyphenation() {
        ...
        var testContainer = tester.appendTests(d.documentElement);
        if (testContainer !== null) {
            Object.keys(H.require).forEach(function checkReqLangs(lang) {
                if (H.require[lang] !== "FORCEHYPHENOPOLY") {
                    var el = d.getElementById(lang);
